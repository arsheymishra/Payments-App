...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://payments-app-api2.vercel.app/api/v1/account/balance', {
      method: 'GET',
      headers: {
  ...
  const handleSearch = (e) => {
    ...
    fetch(`https://payments-app-api2.vercel.app/api/v1/user/bulk?filter=${e.target.value}`, {
      method: 'GET',
      headers: {
        Authorization: `Bearer ${localStorage.getItem('token')}`,
      },
  ...
  const handleSendMoney = () => {
    ...
    fetch('https://payments-app-api2.vercel.app/api/v1/account/transfer', {
      method: 'POST',
      headers: {
